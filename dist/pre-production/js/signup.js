...
/***/ function(module, exports, __webpack_require__) {
	...
	var _exportsValidatinatorValidatinator = __webpack_require__(40);

	var _exportsValidatinatorValidatinator2 = _interopRequireDefault(_exportsValidatinatorValidatinator);
	...
	new _vue2.default({
	  ...
	  ready: function ready() {
	    ...
	    this.formValidator = new _exportsValidatinatorValidatinator2.default({
	      "signupForm": {
	  ...
	  methods: {
	    ...
	    onFormSubmit: function onFormSubmit(e) {
	      ...
	      var errors, fieldNames, fields, form;

	      e.preventDefault();
	      form = new _form2.default(this.$els.signupform);
	      ...
	      if (this.formValidator.fails("signupForm")) {
	        ...
	        _auth2.default.signup(form.getData()).then(this.onFormSubmitComplete.bind(this), this.onFormSubmitError.bind(this));
	      }
	    },
	    onFormSubmitComplete: function onFormSubmitComplete(details) {
...
/***/ function(module, exports) {
	...
	var Response = function () {
	  ...
	  _createClass(Response, null, [{
	    key: "validate",
	    value: function validate(resolve, reject, xhr) {
	      var response;
	    ...
	    value: function send() {
	      ...
	      return new Promise(function (resolve, reject) {
	        ...
	        for (var prop in _this.headers) {
	          if (_this.headers.hasOwnProperty(prop)) {
	            _this.xhr.setRequestHeader(prop, _this.headers[prop]);
	          }
	        }
	        _this.xhr.onreadystatechange = function () {
	          ...
	          if (_this.xhr.readyState === 4) {
	            if (_this.xhr.status >= 400 || _this.xhr.status === 0) {
	              reject(_this.xhr);
	            } else {
	              resolve(_this.xhr);
	            }
	  ...
	  _createClass(Auth, null, [{
	    ...
	    value: function login(credentials) {
	      return new Promise(function (resolve, reject) {
	        ...
	        req = new _request2.default("http://localhost:8080/login", "POST", body, headers);
	        req.send().then(_response2.default.validate.bind(null, resolve, reject), _response2.default.validate.bind(null, resolve, reject));
	      });
	    }
	  }, {
	    key: "signup",
	    value: function signup(account) {
	      return new Promise(function (resolve, reject) {
	        ...
	        req = new _request2.default("http://localhost:8080/users", "POST", body, headers);
	        req.send().then(_response2.default.validate.bind(null, resolve, reject), _response2.default.validate.bind(null, resolve, reject));
	      });
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	var FormException = exports.FormException = function (_Error) {
	  _inherits(FormException, _Error);

	  function FormException(code, message) {
	    _classCallCheck(this, FormException);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(FormException).call(this, message));

	    _this.code = code;
	    _this.name = "FormsException";
	    return _this;
	  }
	...
	var Form = function () {
	  ...
	  _createClass(Form, [{
	    ...
	    value: function getData() {
	      ...
	      var data, el, isCheckedInputFound, fields, name;
	              ...
	              if (["checkbox", "radio"].indexOf(el[0].type) > -1) // NOTE: case 1 => radio and checkbox inputs
	                {
	                  ...
	                  try {
	                    for (var _iterator = el[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) // NOTE: loops through inputs to find the selected item
	                    {
	    ...
	    value: function getFields() {
	      var hiddenFields = arguments.length <= 0 || arguments[0] === undefined ? true : arguments[0];
	      var asArray = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];


	      var els, fields, fieldNames, i, length, name;
	    ...
	    value: function getFieldNames() {
	      ...
	      var f, elements, fieldNames, i, length;
	    ...
	    key: "_isHiddenInput",
	    value: function _isHiddenInput(field) {
...
/***/ function(module, exports) {
	...
	/* 
	 * Copyright (c) 2013-2015 David Jenkins (validatinator) 
